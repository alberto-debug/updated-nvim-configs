return {
  ...
  config = function()
    require("obsidian").setup {
      ...
      mappings = {
        ...
        ["<leader>cd"] = {
          action = function()
            ...
            if line:match "%[ %]" then vim.api.nvim_set_current_line(line:gsub("%[ %]", "[x]")) end
          end,
          opts = { buffer = true },
          desc = "Mark checkbox as done",
        },
      },
      ...
      follow_img_func = function(img) vim.fn.jobstart { "qlmanage", "-p", img } end,
